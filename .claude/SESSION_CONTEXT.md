...
| Batch 16 status | **In Progress**. WP-0 done, WP-1 next. Definition: `BATCH16_DEFINITION.md`. |
...
- Newest current-batch entry: 2026-03-03 - WP-0: migrate smoke_cache_check to scripts/testing/ (Batch 16 WP-0).
<!-- DOCSYNC:STATUS-END -->
