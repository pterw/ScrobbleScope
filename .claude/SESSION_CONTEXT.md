...
|------|-------|
| Branch | `wip/batch-21` |
| Tests | **798 passing** across 40 test modules |
...
- Latest validated test count: **798 passed**.
...
| test_docsync_declarations.py | 49 |
