...
|------|-------|
| Branch | `wip/batch-21` |
| Tests | **792 passing** across 40 test modules |
...
- Latest validated test count: **792 passed**.
...
| test_docsync_declarations.py | 43 |
