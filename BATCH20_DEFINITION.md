# BATCH20: UI overhaul -- TBD

**Status:** Placeholder. Scope to be defined in a future session.
**Branch:** to be decided when scope is finalized.
**Baseline:** 387 tests passing at Batch 19 close-out (2026-05-19).
...
To be expanded into proper WPs once owner finalizes the scope. This file
exists so PLAYBOOK Section 3 has an active-batch target after Batch 19
close-out without committing to specific work packages prematurely.
