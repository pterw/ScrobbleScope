...
- `docs/agents/AGENT_NOTES.md` -- owner preferences, local setup, constraints
- `docs/agents/PLAYBOOK.md` -- work order and execution history
- `BATCHN_DEFINITION.md` -- the active batch's scope and acceptance criteria
  (the file named in `docs/agents/PLAYBOOK.md` Section 3)
- `DESIGN.md`, `docs/design/RECONCILIATION.md`, `docs/design/designsystemaudit.md` -- the design system
- `docs/agents/FINDINGS.md` -- issues
