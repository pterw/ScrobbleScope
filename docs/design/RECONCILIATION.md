...
| Header pills | Prototype scaffolding, do not build | Production navigation: Home, Heatmap, Results, Unmatched. At mobile widths the destinations use a directly visible two-by-two grid beside the compact theme control, with no horizontal scrolling. | Owner decision, `624ebb9`, refined after owner mobile review |
