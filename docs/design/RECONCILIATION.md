...
| Wide index composition | `1.1fr 1fr`, form capped at 380px | At 1200px and wider, `3fr 4fr`; form capped at 448px before the shared `1.075` composition scale | Owner review prioritises the application column while preserving equal component scale at 1080p, 1440p, and 4K |
